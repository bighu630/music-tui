...
// startPlay 播放歌曲：切首页、置播放状态，并行触发
// 播放 / 歌词 / 封面 / 历史 四个动作（核心链路 1）。
...
func playCmd(p player.Player, track model.Track) tea.Cmd {
	return func() tea.Msg {
		return playResultMsg{track: track, err: p.Play(track.URL)}
	}
}
